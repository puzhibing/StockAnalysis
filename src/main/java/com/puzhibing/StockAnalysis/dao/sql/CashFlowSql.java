...
public class CashFlowSql {
	...
	public String insertCashFlow(CashFlow cashFlow) {
		return new SQL() {{
			...
			INTO_COLUMNS("cfooia , ncffia , crfi , crfb , crftiob , ocrtfar , ciofa , cfdr , cpfdpoip , poocrtfa , cfoofa , ncfgbfra , teoerfocace");
			...
			INTO_VALUES("#{cfooia} , #{ncffia} , #{crfi} , #{crfb} , #{crftiob} , #{ocrtfar} , #{ciofa} , #{cfdr} , #{cpfdpoip} , #{poocrtfa} , #{cfoofa} , #{ncfgbfra} , #{teoerfocace}");
	...
	public String selectCashFlowByCompanyStockId(String companyStockId) {
		return new SQL() {{
			...
			SELECT("cfooia , ncffia , crfi , crfb , crftiob , ocrtfar , ciofa , cfdr , cpfdpoip , poocrtfa , cfoofa , ncfgbfra , teoerfocace");
