 ...
 *
 */
public class CashFlow extends StockDataBean {

    private String crfsogas;//销售商品、提供劳务收到的现金

    private String ort;//收到的税费返还

    private String cortbar;//收到的其他与经营活动相关的现金

    private String ciioa;//经营活动现金流入小计
    ...
    private String cffoa;//经营活动现金流出小计

    private String ncffoa;//经营活动产生的现金流净额

    private String crfir;//收回投资收到的现金

    private String crfii;//取得投资收益收到的现金

    private String ncidofaiaaoaitpp;//处置固定资产、无形资产和其他上期资产收回的现金净额

    private String ncrfdosaobu;//处置子公司及其他营业单位收到的现金净额

    private String ocrtiahbr;//收到其他与投资活动相关的现金

    private String cioia;//投资活动现金流入小计

    private String cofaiaaocpfpi;//构建固定资产、无形资产和其他上期投资支付的现金

    private String cpfi;//投资支付的现金

    private String ncpbsaobu;//取得子公司及其他营业单位支付的现金净额

    private String poocrtia;//支付其他与投资活动有关的现金

    private String cfooia;//投资活动现金流出小计

    private String ncffia;//投资活动产生的现金流净额

    private String crfi;//吸收投资收到的现金
    ...
    private String cfoofa;//筹资活动现金流出小计

    private String ncfgbfra;//筹资活动产生的现金流量净额

    private String teoerfocace;//汇率变动对现金及现金等价物的影响

    private String niicace;//现金及现金等价物净增加额

    private String caceatboty;//期初现金及现金等价物余额
