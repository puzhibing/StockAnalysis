...
public class NonCurrentLiabilitiesServiceImpl implements NonCurrentLiabilitiesService {
	 ...
	 */
	@Override
	public ResultBean<Object> insertNonCurrentLiabilities(NonCurrentLiabilities nonCurrentLiabilities, String token) throws Exception {
	 ...
	 */
	@Override
	public ResultBean<Object> updateNonCurrentLiabilities(NonCurrentLiabilities nonCurrentLiabilities, String token) throws Exception {
		resultBean = new ResultBean<>();
		if(null != nonCurrentLiabilities && !StringUtils.isEmpty(token)) {
			user = tokenutil.tokenToUser(token);
	 ...
	 */
	@Override
	public ResultBean<Object> deleteNonCurrentLiabilities(NonCurrentLiabilities nonCurrentLiabilities, String token) throws Exception {
		resultBean = new ResultBean<>();
		if(null != nonCurrentLiabilities && !StringUtils.isEmpty(token)) {
			user = tokenutil.tokenToUser(token);
